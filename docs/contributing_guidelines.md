...
Developers are expected to have successful PRs every week - this means you should submit your PR in advance, some time after one week, so you have time for fixing any issues.

### Making a Pull Request

1. Navigate to the [repository page](https://github.com/cssgunc/nonprofit-management-institute).
